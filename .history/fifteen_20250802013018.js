...
function updateStats() {
  ...
  console.log("Updating stats - Time:", timeElapsed, "Moves:", moveCount); // Debug log
  
  if (timeElement) {
    timeElement.textContent = timeElapsed;
    console.log("Time element updated to:", timeElapsed);
  } else {
  ...
  if (movesElement) {
    ...
    console.log("Moves element updated to:", moveCount);
  } else {
